...
I purchased the domain shavaiz.cloud and configured DNS using GoDaddy DNS manager.

A-Record (Main Domain)
Type	Name	Value	TTL
A	@	4.230.142.25	Default
CNAME (WWW → Root Domain)
Type	Name	Value	TTL
CNAME	www	shavaiz.cloud	Default
...
✔ DNS Test
ping shavaiz.cloud
Resolves to 4.230.142.25

✔ Firewall Test
sudo ufw status
Shows allowed: OpenSSH, Nginx HTTP

Script Test
Running the script generates a backup in:
